...
# Read the data
global_mpox_only <- readxl::read_excel("~/Library/CloudStorage/OneDrive-Personal/GitHub/codes_for_reports/mpox_situation_report_files/distribution mpox variants.xlsx", 
...
# Read the data
asean_mpox_only <- readxl::read_excel("~/OneDrive/GitHub/codes_for_reports/MMWR/files/distribution mpox variants.xlsx", 
...
# Read the data
aseanMpox <- readxl::read_excel("~/OneDrive/GitHub/codes_for_reports/MMWR/files/computation_covid_19_mpox.xlsx", 
